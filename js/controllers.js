...
.factory('StorageService', function($localStorage) {
    ...
    var _remove = function(thing) {
        $localStorage.things.splice(thing, 1);
        $localStorage.things1.splice(thing, 1);
    }
...
.factory('StorageOutwardService', function($localStorage) {
    ...
    var _remove = function(thing) {
        $localStorage.thingsout.splice(thing, 1);
        $localStorage.things1out.splice(thing, 1);
    }
...
.controller('NotificationCtrl', function($scope, $state, $location, $ionicLoading, $cordovaFileTransfer, $filter, $ionicModal, $cordovaToast, $http, $cordovaCamera, $timeout) {
    ...
    $http({
        method: "GET",
        url: "http://api.skyjinxtechnology.com/api/complain/gettotalfinalcompletecomplain",
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'Authorization': token
        }
        ...
        $scope.FinalComplaincount = response.Data;
    })

    $http({
        method: "GET",
        url: "http://api.skyjinxtechnology.com/api/complain/gettotalpendingcomplain",
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'Authorization': token
        }
        ...
        console.log(response);
        //$scope.totalCount = response.data.totalCount;
        $scope.PendingComplaincount = response.Data;
    })


    $http({
        method: "GET",
        url: "http://api.skyjinxtechnology.com/api/complain/gettotalcompletecomplain",
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'Authorization': token
        }
        ...
        console.log(response);
        //$scope.totalCount = response.data.totalCount;
        $scope.CompletedComplaincount = response.Data;
    })


    $http({
        method: "GET",
        url: "http://api.skyjinxtechnology.com/api/invoice/gettotalduepayment",
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'Authorization': token
        }
        ...
        console.log(response);
        //$scope.totalCount = response.data.totalCount;
        $scope.DuePaymentcount = response.Data;
    })

    $http({
        method: "GET",
        url: "http://api.skyjinxtechnology.com/api/invoice/GetTotalPaidPayment",
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'Authorization': token
        }
        ...
        console.log(response);
        //$scope.totalCount = response.data.totalCount;
        $scope.PaidPaymentcount = response.Data;
    })

    $http({
        method: "GET",
        url: "http://api.skyjinxtechnology.com/api/invoice/GetTotalOverduePayment",
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'Authorization': token
        }
        ...
        console.log(response);
        //$scope.totalCount = response.data.totalCount;
        $scope.OverDuePaymentcount = response.Data;
    })

    $http({
        method: "GET",
        url: "http://api.skyjinxtechnology.com/api/contact/gettotalnewconnection",
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'Authorization': token
        }
        ...
        console.log(response);
        //$scope.totalCount = response.data.totalCount;
        $scope.NewConnectioncount = response.Data;
    })

    $http({
        method: "GET",
        url: "http://api.skyjinxtechnology.com/api/contact/gettotalcutconnection",
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'Authorization': token
        }
        ...
        console.log(response);
        //$scope.totalCount = response.data.totalCount;
        $scope.CutConnectioncount = response.Data;
    })

    $http({
        method: "GET",
        url: "http://api.skyjinxtechnology.com/api/contact/gettotalconnection",
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'Authorization': token
        }
        ...
        console.log(response);
        //$scope.totalCount = response.data.totalCount;
        $scope.TotalConnectioncount = response.Data;
    })
    ...
    $scope.PlanchangeDetail = function() {
        //localStorage.setItem("Id", Id);
        $scope.show($ionicLoading);
    ...
    // Count details Pages
    $scope.PComplainDetail = function() {
        $state.go('pcomplain');
        $scope.show($ionicLoading);
    }

    $scope.FCComplainDetail = function() {
        $state.go('fccomplain');
        $scope.show($ionicLoading);
    }

    $scope.CComplainDetail = function() {
        $state.go('ccomplain');
        $scope.show($ionicLoading);
    }

    $scope.PComplainDetailPage = function() {

        $http({
            method: "GET",
            url: "http://api.skyjinxtechnology.com/api/complain/getpendingcomplain",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': token
            }
    ...
    $scope.CComplainDetailPage = function() {

        $http({
            method: "GET",
            url: "http://api.skyjinxtechnology.com/api/complain/getcompletecomplain",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': token
            }
    ...
    $scope.FCComplainDetailPage = function() {

        $http({
            method: "GET",
            url: "http://api.skyjinxtechnology.com/api/complain/getfinalcompletecomplain",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': token
            }
        }).success(function(response) {
            $scope.fcc = response.Data;
            console.log(response);
            $scope.hide($ionicLoading);
        })
    }

    $scope.DPaymentnDetail = function() {
        $state.go('dpayment');
        $scope.show($ionicLoading);
    }

    $scope.PPaymentnDetail = function() {
        $state.go('ppayment');
        $scope.show($ionicLoading);
    }

    $scope.ODPaymentnDetail = function() {
        $state.go('odpayment');
        $scope.show($ionicLoading);
    }


    $scope.DPaymentDetailPage = function() {

        $http({
            method: "GET",
            url: "http://api.skyjinxtechnology.com/api/invoice/getduepayment",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': token
            }
        }).success(function(response) {
            $scope.duepayment = response.Data;
            console.log(response);
            $scope.hide($ionicLoading);
    ...
    $scope.PPaymentDetailPage = function() {

        $http({
            method: "GET",
            url: "http://api.skyjinxtechnology.com/api/invoice/GetPaidPayment",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': token
            }
        }).success(function(response) {
            $scope.paidpayment = response.Data;
            console.log(response);
            $scope.hide($ionicLoading);
    ...
    $scope.ODPaymentDetailPage = function() {

        $http({
            method: "GET",
            url: "http://api.skyjinxtechnology.com/api/invoice/GetOverduePayment",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': token
            }
        }).success(function(response) {
            $scope.oduepayment = response.Data;
            console.log(response);
            $scope.hide($ionicLoading);
    ...
    $scope.NConnectionDetail = function() {
        $state.go('nconnection');
        $scope.show($ionicLoading);
    }

    $scope.CConnectionDetail = function() {
        $state.go('cconnection');
        $scope.show($ionicLoading);
    }

    $scope.GConnectionDetail = function() {
        $state.go('gconnection');
        $scope.show($ionicLoading);
    }

    $scope.NConnectionDetailPage = function() {

        $http({
            method: "GET",
            url: "http://api.skyjinxtechnology.com/api/contact/getnewconnection",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': token
            }
        }).success(function(response) {
            $scope.newconn = response.Data;
            console.log(response);
            $scope.hide($ionicLoading);
    ...
    $scope.CConnectionDetailPage = function() {

        $http({
            method: "GET",
            url: "http://api.skyjinxtechnology.com/api/contact/getcutconnection",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': token
            }
        }).success(function(response) {
            $scope.cutconn = response.Data;
            console.log(response);
            $scope.hide($ionicLoading);
    ...
    $scope.GConnectionDetailPage = function() {

        $http({
            method: "GET",
            url: "http://api.skyjinxtechnology.com/api/contact/getconnection",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': token
            }
        }).success(function(response) {
            $scope.getconn = response.Data;
            console.log(response);
            $scope.hide($ionicLoading);
...
.controller('AppCtrl', function($scope, $state, $rootScope, $cordovaToast, $ionicLoading, $http, $cordovaCamera, $timeout) {
    ...
    $scope.login_role = function(email) {
        ...
        if ($scope.LoginData.Email == undefined) {
            ...
            $.ajax({
                type: 'POST',
                //url: 'http://localhost:50267/api/account/token',
...
.controller('CustomerListCtrl', function($scope, $cordovaToast, $ionicLoading, $ionicPopup, $http, $state, $ionicHistory) {
    ...
    $scope.exportData = function() {
        ...
        saveAs(blob, "Customers List.xls");
    };
...
.controller('AdminCtrl', function($scope, $filter, $ionicLoading, $cordovaToast, $http, $state, $ionicPopup, $ionicHistory) {
    ...
    $scope.edit_customer = function(UserId, UserName, Name, Email, Phone, Mobile, Street1, Street2, City, State, Country, ZipCode, RadiusId, RadiusUsername, RadiusPassword, PlanName,
    ...
    $scope.edit_user = function(UserId, UserName, Name, Email, Phone, Mobile, Street1, Street2, City, State, Country, ZipCode, UserRole) {
        $scope.show($ionicLoading);
...
.controller('TestCtrl', function($scope, $state, $ionicLoading, $cordovaToast, $cordovaCamera, $cordovaFileTransfer, $http) {
    ...
    .controller('StocklistCtrl', function($scope, $state, $cordovaToast, $ionicLoading, StorageService, $ionicModal, $cordovaCamera, $cordovaFileTransfer, $http) {
...
.controller('StockCtrl', function($scope, $state, $localStorage, $ionicLoading, StorageService, StorageOutwardService, $ionicModal, $cordovaCamera, $cordovaToast, $cordovaFileTransfer, $http) {
    ...
    $scope.p_id = function(Name) {
        var Id = $scope.Inward.Data.Id;
        localStorage.setItem("pname", Name);
        $scope.show($ionicLoading);
        $http({
            method: "GET",
            url: "http://api.skyjinxtechnology.com/api/plan/getvariantbyproduct?productId=" + Id,
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': token
            }
...
.controller('PendingComplainCtrl', function($scope, $ionicLoading, $location, $filter, $state, $cordovaFile, $http, $cordovaToast, $ionicHistory, $cordovaCamera, $cordovaFileTransfer, $ionicModal, $timeout) {
    ...
    $scope.Pending = function() {
        ...
        $scope.exportData = function() {
            ...
            saveAs(blob, "Pending Complain.xls");
        };
    ...
    $scope.InProgress = function() {
        ...
        $scope.exportData = function() {
            ...
            saveAs(blob, "InProgress Complain.xls");
        };
    }
    ...
    $scope.Complete = function() {
        ...
        $scope.exportData = function() {
            ...
            saveAs(blob, "Complete Complain.xls");
        };
    ...
    $scope.FinalComplete = function() {
        ...
        $scope.exportData = function() {
            ...
            saveAs(blob, "Final complete Complain.xls");
        };
    }
...
.controller('OutwardCtrl', function($scope, $cordovaToast, $localStorage, StorageOutwardService, $ionicLoading, $ionicModal, $state, $http, $timeout) {
    ...
    $scope.RemoveItem1 = function(index) {
        ...
        var InvoiceDetails = StorageOutwardService.getAll();
        if (InvoiceDetails == '') {
    ...
    $scope.addToCart1 = function(qty) {
        ...
        var message = localStorage.getItem("QtyMessage");
        var products = localStorage.getItem("QtyProducts");
        ...
        if (qty == undefined) {
            ...
            $cordovaToast.show('No products found', 'short', 'center');
        } else if (qty > products) {
            $cordovaToast.show('Available Quantity is ' + products, 'short', 'center');
        } else {
    ...
    $scope.v_id = function(Name) {
        ...
        var v_id = $scope.Outward.Variant.Id;
        localStorage.setItem("vname", Name);
        $scope.show($ionicLoading);
        $http({
            method: "GET",
            url: "http://api.skyjinxtechnology.com/api/plan/getqtybyprodvrnt?productId=" + p_id + "&variantId=" + v_id,
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': token
            }
            ...
            $scope.hide($ionicLoading);
            localStorage.setItem("QtyMessage", response.Message);
            localStorage.setItem("QtyProducts", response.Data[0].Quantity);
        })
...
.controller('VariantCtrl', function($scope, $state, $cordovaToast, $ionicLoading, $http, $timeout) {
    ...
    $scope.Add_variant = function() {
        ...
        $http({
            ...
            $scope.Variant.Data.IsPlanSpecific = true;
            $scope.Variant.Data.PlanId = response.Data[0];
